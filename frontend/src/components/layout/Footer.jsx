    ...
    <footer className="bg-secondary mt-12 border-t border-border">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* About */}
          <div>
            <h3 className="text-xl font-bold text-primary mb-4">NexusMart</h3>
            <p className="text-muted-foreground text-sm leading-relaxed mb-4">
              Your one-stop destination for premium products. We offer the best quality items with fast delivery and excellent customer service.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/shipping" className="text-muted-foreground hover:text-primary transition-colors">Shipping Information</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-muted-foreground">123 E-Commerce Blvd, Tech City, TC 12345</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-muted-foreground">support@nexusmart.com</span>
              </li>
            </ul>
          </div>
